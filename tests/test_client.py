...
class FlaskClientTestCase(unittest.TestCase):
    """
    Заготовка модульного теста,
    используещего тестового клиента.
    Имитация создания и использования
